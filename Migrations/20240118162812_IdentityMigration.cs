            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    GameId = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    MainPhotoName = table.Column<string>(type: "TEXT", nullable: false),
                    Photo1Name = table.Column<string>(type: "TEXT", nullable: false),
                    Photo2Name = table.Column<string>(type: "TEXT", nullable: true),
                    Photo3Name = table.Column<string>(type: "TEXT", nullable: true),
                    Photo4Name = table.Column<string>(type: "TEXT", nullable: true),
                    PublisherId = table.Column<int>(type: "INTEGER", nullable: false),
