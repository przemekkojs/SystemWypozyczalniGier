...
namespace SystemWypozyczalniGier.Controllers
{
    public class AccountsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Email,Name,Surname,PhoneNumber,Password,Role")] Account account)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("Email,Name,Surname,PhoneNumber,Password,Role")] Account account)
        {
            if (id != account.Email)
            {
                return NotFound();
