...
namespace SystemWypozyczalniGier.Controllers
{
    public class ReviewsController : Controller
    {
        ...
        {
            var databaseContext = _context.Reviews.Include(r => r.Game);
        ...
        public async Task<IActionResult> Create([Bind("ReviewId,GameId,Mark,Comment")] Review review)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ReviewId,GameId,Mark,Comment")] Review review)
        {
