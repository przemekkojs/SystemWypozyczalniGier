...
namespace SystemWypozyczalniGier.Controllers
{
    public class GamesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("GameId,PublisherId,Title,Description,Price,QuantityInStock,MaxQuantity,Accessibility,Discount,Pegi")] Game game)
        {
